...
class HandClass(val deck: DeckClass, val name: String) {
    ...
    fun getValueHand(hand: HandClass): Int {
        ...
        if (hand.legalCombiSign(hand.getCard(0), hand.getCard(1)) === true && hand.legalCombiSign(
                hand.getCard(1),
                hand.getCard(2)
            ) === true && hand.legalCombiSign(hand.getCard(0), hand.getCard(2)) === true
        ) {
            threeSign = true
        } else if (hand.legalCombiSign(
                hand.getCard(0),
                hand.getCard(1)
            ) === true || hand.legalCombiSign(
                hand.getCard(1),
                hand.getCard(2)
            ) === true || hand.legalCombiSign(hand.getCard(0), hand.getCard(2)) === true
        ) {
        ...
        if (hand.legalCombiNum(
                hand.getCard(0),
                hand.getCard(1)
            ) === true && hand.legalCombiNum(
                hand.getCard(1),
                hand.getCard(2)
            ) === true && hand.legalCombiNum(hand.getCard(0), hand.getCard(2)) === true
        ) {
            threeNum = true
        } else {
            oneNum = true
