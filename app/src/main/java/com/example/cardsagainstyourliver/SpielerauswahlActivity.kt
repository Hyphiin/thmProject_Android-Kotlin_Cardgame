...
import com.example.cardsagainstyourliver.R.color.backgroundColor2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameList.onItemClickListener = object : AdapterView.OnItemClickListener {
            ...
            override fun onItemClick(parent: AdapterView<*>, view: View,
                ...
                if(selected.contains(id)){
                    ...
                    parent.getChildAt(position).setBackgroundColor(Color.parseColor("#007d7c"))
                }
                else{
                    selected.add(id)
        ...
        btn_start.setOnClickListener{
            if(selected.size==2){
                ...
                Toast.makeText(this, "Es können lediglich zwei Spieler ausgewählt werden", Toast.LENGTH_SHORT).show()
            }
        }
